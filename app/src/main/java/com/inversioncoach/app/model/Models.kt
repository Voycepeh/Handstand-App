...
data class UserSettings(
    ...
    val maxStorageMb: Int = AppSettingsPolicy.defaultStorageMb,
    val startupCountdownSeconds: Int = AppSettingsPolicy.defaultCountdownSeconds,
    val annotatedExportQuality: String = AppSettingsPolicy.defaultExportQuality.name,
